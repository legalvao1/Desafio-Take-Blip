...
using Take.Api.BancoPanCartoes.Facades.Helpers;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddSingletons(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton(settings)
                    ...
                    .AddSingleton<IErrorResponseHelper, ErrorResponseHelper>()
                    .AddSingleton<IGithubRepositoriesFacade, GithubRepositoriesFacade>()
                    .AddSingleton<IOrganizationRepositoryLanguagesFacade, OrganizationRepositoryLanguagesFacade>();


            var restEase = RestClient.For<IRestEaseService>(new HttpClient());
